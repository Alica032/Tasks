...
//            gpu::Device device = gpu::chooseGPUDevice(2, argvv);
    ...
    // это достигается использованием thread-local переменных, т.е. на самом деле контекст будет активирован
    // для текущего потока исполнения
    gpu::Context context;
    ...
    // т.о. программе не будет нужно в runtime читать файл с диска, т.к. исходник кернелов теперь хранится
    // в массиве данных основной программы
